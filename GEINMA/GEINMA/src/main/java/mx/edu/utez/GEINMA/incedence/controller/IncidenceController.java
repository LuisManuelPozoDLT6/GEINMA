...
public class IncidenceController {
    ...
    public ResponseEntity<Message> save(@RequestBody IncidenceDTO incidenceDTO){
        return incidenceService.save(new Incidence(incidenceDTO.getDescription(), formato.format(new Date()), incidenceDTO.getClient(), incidenceDTO.getTechnical(), incidenceDTO.getStatus(), incidenceDTO.getExperience(), incidenceDTO.getPictureIncidence()));
    }
